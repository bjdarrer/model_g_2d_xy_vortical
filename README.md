...
Notes on the method
    ...
    • This follows Lumi’s outline for reaction–diffusion + fluid coupling with isothermal pressure and viscosity, using FFTs for spatial ops and splitting for time stepping (reaction, diffusion, velocity, advection). See overview.pdf @ https://github.com/frostburn/tf2-model-g/blob/master/docs/overview.pdf
